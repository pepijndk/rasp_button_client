...
if __name__ == '__main__':
    ...
    try:
        ...
        while True:
            ...
            colorWipeNoTail(strip, Color(255, 0, 0), 20, 3, 4)  # Red wipe
            colorWipeNoTail(strip, Color(0, 255, 0), 20, 3, 4)  # Blue wipe
            colorWipeNoTail(strip, Color(0, 0, 255), 20, 3, 4)  # Green wipe
